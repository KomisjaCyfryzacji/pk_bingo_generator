...
standard_bingo_var = tk.BooleanVar(value=True)
...
background_entry.insert(0, "./karta.png")
...
center_img_entry.insert(0, "./kwadrat_kolor_cut_no_border.png")
...
font_entry.insert(0, "./Luckiest_Guy/LuckiestGuy-Regular.ttf")
